...
expected_path = ROOT / "tests/public-release/router-quality-expected-v1.csv"
out_path = ROOT / "tests/public-release/router-quality-results-v1.md"
...
lines = []
lines.append("# ZimaBrain CE Router Quality Results v1")
lines.append("")
