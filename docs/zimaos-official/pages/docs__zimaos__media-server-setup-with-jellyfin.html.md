# How to Watch Videos Anywhere with Jellyfin Media Server | Zimaspace Docs

Source: https://www.zimaspace.com/docs/zimaos/media-server-setup-with-jellyfin.html
...
How to Watch Videos Anywhere with Jellyfin Media Server
