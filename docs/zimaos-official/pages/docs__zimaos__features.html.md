# Features-Build Data Station | Zimaspace Docs

Source: https://www.zimaspace.com/docs/zimaos/features.html
...
Download and install the Zima client from find.zimaspace.com .
...
On Mac or Windows : Connect using the address provided in the prompt.

Enter the address : Enter the copied address in the file browser and press Enter.
...
We also welcome more warriors to build their own store system!
The steps to add a third-party store are also very simple. Just open the application center, click the ADD button at the top right of the list, and enter the address of the third-party store. AppStore-Play For example,
